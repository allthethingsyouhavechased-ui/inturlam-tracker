  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-center gap-3 rounded-xl border border-black/10 bg-white p-3 text-sm print:hidden dark:border-white/10 dark:bg-zinc-900">
        <span className="text-xs font-medium text-zinc-500 dark:text-zinc-400">Tarih aralığı:</span>
      ...
      <section className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-500 print:hidden"
          >
            CSV indir
          </button>
        </div>
                ...
                >
                  <td className="px-3 py-2">
                    <details>
                      ...
                      {p.brands.length > 0 && (
                        <ul className="mt-1 space-y-0.5 pl-3 text-xs text-zinc-500 dark:text-zinc-400">
                          {p.brands.map((b) => (
                            <li key={b.brand_id}>
                  ...
                  <td className="px-3 py-2">
                    <details>
                      <summary className="cursor-pointer font-medium">
                        {b.brand_name}
                        {b.archived === 1 && (
                          <span className="ml-1.5 rounded-full bg-black/5 px-1.5 py-0.5 text-[10px] font-normal text-zinc-600 dark:bg-white/10 dark:text-zinc-400">
                            arşiv
                          </span>
                        )}
                      </summary>
