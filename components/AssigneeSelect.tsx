...
const base =
  "cursor-pointer rounded-md border border-black/10 bg-white px-2 py-1 text-xs outline-none focus:border-indigo-500 dark:border-white/15 dark:bg-zinc-900";
